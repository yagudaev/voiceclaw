      ...
      <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[minmax(0,1.1fr)_380px] lg:gap-16">
        <div>
          ...
          <p className="mt-8 max-w-2xl font-[family-name:var(--font-geist-sans)] text-lg leading-8 text-[var(--muted)] md:text-xl">
            ...
            OpenAI-compatible endpoint and it minds the mic, the route, and
      ...
      <div className="grid gap-8 xl:grid-cols-[minmax(0,1.2fr)_340px]">
        <div className="rounded-[24px] border border-[var(--line-strong)] bg-[var(--panel)] p-6 shadow-[var(--shadow)] md:p-8">
          <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_240px]">
            <div className="relative overflow-hidden rounded-[18px] border border-[var(--line-strong)] bg-[var(--panel-strong)] p-6">
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div className="rounded-[18px] border border-[var(--line-strong)] bg-[var(--panel-strong)] p-4">
    ...
    >
      <div className="grid gap-6 xl:grid-cols-[300px_minmax(0,1fr)]">
        <div className="rounded-[22px] border border-[var(--line-strong)] bg-[var(--panel)] p-6 shadow-[var(--shadow)]">
          ...
          <div className="mt-6 flex justify-center rounded-[28px] border border-[var(--line-strong)] bg-[var(--panel-strong)] p-8">
...
function IOSStoreSection() {
  return (
    ...
    >
      <div className="rounded-[24px] border border-[var(--line-strong)] bg-[var(--panel)] p-5 shadow-[var(--shadow)] md:p-8">
        <div className="overflow-hidden rounded-[20px] border border-[var(--line-strong)] bg-[#fbf6ef] shadow-[inset_0_1px_0_rgba(255,255,255,0.5)]">
...
function MacStoreSection() {
  return (
    ...
    >
      <div className="rounded-[24px] border border-[var(--line-strong)] bg-[var(--panel)] p-5 shadow-[var(--shadow)] md:p-8">
        <div className="overflow-hidden rounded-[20px] border border-[var(--line-strong)] bg-[#fbf6ef]">
      ...
      <div className="rounded-[24px] border border-[var(--line-strong)] bg-[var(--panel)] p-5 shadow-[var(--shadow)] md:p-8">
        <BrowserFrame label="voiceclaw.ai">
          ...
          <div className="grid gap-8 px-6 py-10 lg:grid-cols-[minmax(0,1fr)_360px] lg:px-10">
            ...
            <div className="rounded-[18px] border border-[var(--line-strong)] bg-[var(--panel-strong)] p-5">
...
function SignalCard() {
  return (
    <div className="rounded-[22px] border border-[var(--line-strong)] bg-[var(--panel)] p-6 shadow-[var(--shadow)]">
      ...
      <div className="mt-6 rounded-[24px] border border-[var(--line-strong)] bg-[var(--panel-strong)] p-5">
        <div className="flex items-end gap-2">
...
function LogoSizeCard({
  ...
  return (
    <div className="rounded-[18px] border border-[var(--line-strong)] bg-[var(--panel-strong)] p-5">
      <div className="flex min-h-[100px] items-center justify-center rounded-[22px] border border-[var(--line)] bg-white">
        {children}
      </div>
      <div className="mt-4">
...
function PhoneContext() {
  return (
    <div className="mx-auto max-w-4xl">
      <div className="mx-auto flex max-w-[420px] justify-center rounded-[48px] border border-[var(--line-strong)] bg-[var(--panel-strong)] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.6)]">
...
function PhoneScreenshot({
  ...
  return (
    <div className="rounded-[28px] border border-[var(--line-strong)] bg-[var(--panel-strong)] p-3">
...
function BrowserFrame({
  ...
  return (
    <div className="overflow-hidden rounded-[28px] border border-[var(--line-strong)] bg-[#fbf6ef] shadow-[0_20px_40px_rgba(25,21,17,0.08)]">
      <div className="flex items-center gap-2 border-b border-[var(--line)] px-5 py-3">
        <span className="h-3 w-3 rounded-full bg-[#ef6b5d]" />
        <span className="h-3 w-3 rounded-full bg-[#f5bd4f]" />
        <span className="h-3 w-3 rounded-full bg-[#61c554]" />
        <div className="ml-4 flex-1 rounded-full border border-[var(--line-strong)] bg-[var(--paper)] px-4 py-2 font-[family-name:var(--font-geist-sans)] text-sm text-[var(--muted)]">
          {label}
        </div>
      </div>
      {children}
...
function SectionRules() {
  return (
    <div
      aria-hidden
      className="pointer-events-none absolute inset-0 -z-10 [background-image:linear-gradient(to_right,var(--line)_1px,transparent_1px),linear-gradient(to_bottom,var(--line)_1px,transparent_1px)] [background-size:120px_120px]"
    />
  )
}
