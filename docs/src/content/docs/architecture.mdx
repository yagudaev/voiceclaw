...
flowchart LR
    ...
    Relay["Relay Server<br/>(TypeScript / Node.js)<br/><br/>- Session mgmt<br/>- Provider adapter<br/>- Brain agent gateway<br/>- Tracing (Langfuse / OTEL)"]

    Provider["Realtime AI Provider<br/>(Gemini Live / OpenAI Realtime)<br/><br/>- Voice activity detection<br/>- Speech-to-text<br/>- Text-to-speech"]

    Brain["Brain AI<br/>(OpenAI-compatible agent)<br/><br/>- Web search<br/>- Calendar / tasks<br/>- Long-term memory"]

    Mobile -- "WebSocket<br/>relay protocol" --> Relay
    Desktop -- "WebSocket<br/>relay protocol" --> Relay
    Relay <-- "Provider WebSocket<br/>audio + video" --> Provider
    Provider -- "tool call: ask_brain" --> Relay
    Relay <-- "POST /v1/chat/completions<br/>(SSE stream)" --> Brain
...
*[Edit this diagram ↗](https://mermaid.live/edit#pako:eNqdVO9v2jAQ_VdO6ZdWDWOsFHWoqtQfaKrEytSg7cMyTRfnAh6JHdmGFlX933eJEwj90ml8AHM-v3v33tkvgdApBeMgy_WTWKJxMH2MFfDHrpOFwXIJt7kk5ezPOGhWcfDLpwCk0pBwUiuY37SxrzqROXG6X8B1WV4mpn91_EgoHDygkxuCPkyeSx2CnEUn9XYTx3UqNdz3Z50qd2RXTpcM2az2mJOc6xuufwoe_hTmKPMnqdIQChQt-g9K4LqGPgUrDJECy-3SrgqpNFZ--Ug5brlY_QsRmQ0ZX22-LSkSRpaO-T-wch_-WI9ff_U42dpKjWJRuCb0zeiNTMkApli6BqkHNwalAlywoLBAR0-4bXbmBoVUCzieolpka1tpNZtPpic1V0-xBa1ZYu5kwTrf78Ke7RcqpJIw9XLPSlKc0qYf0P6upWDp2cmNdFtIyXlX265KIrHsOd1z9Nz2NedlFbL1Zodb3RkT8x1e33syvnxP6KJkoxOei7r3AxqVSZbQiGUTuMWcfUHD9B3alW3CU60WTMUUUFChzbZTvJm5Xg_igOEiLVbkGZvazdJop4XO44BzrrzV_mQ7Wv9x1A_KZX1yZ_chBDazV-3pBqFNPbTUE3Ba5yAwz8fAjf9OKi3fKTyL5tDfDPp8jV2_0jmnykMv2nEUTcA6Q1icNDi1P61uIkdr7yjjRXXHI7dlFTPJ9Y8GYjA6G4V8WK9ofDQSo7MsC1kIbcZH2XnG_95g1Hp1IYZ4lqWfdxBiKAbvQJSNGgdEhoOPn3CHcpFcDPcoHvMNSi1bF-ITDrJz8a9EmmkK29HoaNPN8i7sm-7u7Vw9aKib4a_JnmmsgjAoeLhRpvwwv1S5PA9LKvixGvOS78MqDmL1ynm4djraKhGMnVlTGKzLlN-SO4n8dBc--PoXJp3ykQ)*
