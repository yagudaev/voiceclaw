    ...
    <KeyboardAvoidingView
      ...
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
        <Card className="gap-4 p-4">
          <Text className="text-foreground text-lg font-semibold">Vapi Configuration</Text>
          ...
          <View className="gap-2">
            <Text className="text-muted-foreground text-sm">Assistant ID</Text>
            <Input
          ...
          <View className="gap-2">
            <Text className="text-muted-foreground text-sm">Default Model</Text>
            <Input
